...
<SF label="3. Kobo" desc="Web scraping for ebooks" warn={s.kobo_enabled?"Results may be incomplete or mixed for some authors":undefined}><div style={{display:"flex",alignItems:"center",gap:10}}><span style={{fontSize:12,color:s.kobo_enabled?t.grnt:t.tg,fontWeight:600}}>{s.kobo_enabled?"Active":"Disabled"}</span><STog on={s.kobo_enabled} onToggle={()=>upd("kobo_enabled",!s.kobo_enabled)}/></div></SF>
