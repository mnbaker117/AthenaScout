...
<Btn size="sm" onClick={scanSources} disabled={scanning||clearing} style={{background:t.grn+"22",color:t.grnt,border:`1px solid ${t.grn}44`}}>{scanning?"…":""} Scan Sources</Btn>
{mamOn?<Btn size="sm" onClick={scanMam} disabled={scanning||clearing} style={{background:t.accent+"22",color:t.accent,border:`1px solid ${t.accent}44`}}>{scanning?"…":""} Scan MAM</Btn>:null}
<span style={{width:1,height:20,background:t.border,margin:"0 4px"}}/>
<Btn size="sm" onClick={()=>clearData("source")} disabled={clearing||scanning} style={{background:t.ylw+"22",color:t.ylwt,border:`1px solid ${t.ylw}44`}}>Clear Source Data</Btn>
{mamOn?<Btn size="sm" onClick={()=>clearData("mam")} disabled={clearing||scanning} style={{background:t.cyan+"22",color:t.cyant,border:`1px solid ${t.cyan}44`}}>Clear MAM Data</Btn>:null}
{mamOn?<Btn size="sm" onClick={()=>clearData("both")} disabled={clearing||scanning} style={{background:t.red+"22",color:t.redt,border:`1px solid ${t.red}44`}}>Clear Both</Btn>:null}
